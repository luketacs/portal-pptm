        ...
        @if (!isValidToken()) {
          <div class="text-center py-6">
            ...
            <button (click)="goToForgotPassword()"
              class="w-full bg-blue-600 text-white font-semibold py-3 px-4 rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition duration-150 ease-in-out shadow-lg">
              Solicitar Novo Link
            </button>
          </div>
        }
        ...
        @if (isValidToken() && !submitted()) {
          <form (ngSubmit)="onSubmit()" class="space-y-5">
            ...
            <button type="submit" [disabled]="loading() || !isFormValid()"
              class="w-full bg-blue-600 text-white font-semibold py-3 px-4 rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition duration-150 ease-in-out shadow-lg flex items-center justify-center disabled:bg-blue-400 disabled:cursor-not-allowed">
              @if (loading()) {
