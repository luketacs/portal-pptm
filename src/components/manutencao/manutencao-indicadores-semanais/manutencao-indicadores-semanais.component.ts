...
export class ManutencaoIndicadoresSemanaisComponent implements OnInit, OnDestroy {
  ...
  qtdFolgas = computed(() => {
    const semanas = this.semanasDoPeriodoSet();
    return this.manutencaoService.ordens()
  ...
  // "X de Y executadas (Z parcial)" — só menciona parciais quando existir alguma, pra
  // não poluir o card nas semanas sem esse caso.
